...
import { ExternalLink, Code2, Globe, Smartphone, ChevronDown, Send, MapPin, CheckCircle, Menu, X, Zap, Shield, Clock, Star } from "lucide-react";
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              {ADDONS.map(({ category, items }) => (
                <div key={category} style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
                  <button onClick={() => setOpenAddon(openAddon === category ? null : category)} style={{ width: "100%", background: "none", border: "none", color: "#fafafa", cursor: "pointer", padding: "1.25rem 0", display: "flex", justifyContent: "space-between", alignItems: "center", fontFamily: "inherit", fontSize: "14px", fontWeight: 500 }}>
                    <span>{category}</span>
          ...
          {formspree.succeeded ? (
            ...
            <form onSubmit={handleFormspreeSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div>
                ...
                <textarea name="message" rows={4} placeholder="Tell me about your business and what you're looking for..." required style={{ width: "100%", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", padding: "11px 14px", color: "#fafafa", fontSize: "14px", fontFamily: "inherit", resize: "vertical" }} />
